...
namespace GameLauncher
{
    public partial class Arcanoid : Form
    {
        ...
        public Arcanoid()
        {
            ...
            timer11.Tick += new EventHandler(update);
        ...
        public void Init()
        {
            ...
            arcanoidSet = new Bitmap(System.IO.Path.Combine(new System.IO.DirectoryInfo(System.IO.Directory.GetCurrentDirectory()).Parent.Parent.FullName.ToString(), "Images\\arcanoid.png"));
            timer11.Interval = 40;
