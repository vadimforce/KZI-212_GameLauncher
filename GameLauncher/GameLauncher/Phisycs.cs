...
{
    public partial class Phisycs : Form
    {
        ...
        private void Phisycs_Load(object sender, EventArgs e)
        {
        ...
        {
            MessageBox.Show("2048 - игра в которой с помошью стрелок на клавиаруте необходимо обьединять одинаковые числа друг с другом. Целью игры является достижение на экране числа 2048");
        }
    }
}
